...
## 引き際に備えるか。**どれも総量は揃えてある**（ゴールド 40 ≒ 品 1 個で数えて
## どれも 150）。揃っていないと、いちばん多い型が常に最適になって
## **選ぶ意味が消える**（実際 120〜190 とばらけていて、関門が落とした）。
const SUPPLY_SETS: Array[Dictionary] = [
	{
		"id": "coin", "name": "かねだのみ",
		"desc": "ゴールドに寄せる。店で組み立てる。",
		"gold": 150, "herb": 0, "water": 0,
	},
	{
		"id": "salve", "name": "そなえ",
		"desc": "やくそうに寄せる。道中で保たせる。",
		"gold": 30, "herb": 3, "water": 0,
	},
	{
		"id": "spring", "name": "みずがめ",
		"desc": "まほうの水に寄せる。魔法で押す。",
		"gold": 30, "herb": 1, "water": 2,
	},
	{
		"id": "even", "name": "みつぞろえ",
		"desc": "三つに分ける。どの世界にも噛み合う。",
		"gold": 70, "herb": 1, "water": 1,
	},
]
