...
候補原画は正面立ちの `24x32`、透明を除いて15色以内、BGR555、二値アルファ。
ただしファイル寸法だけが同じで、実体は幅14〜18px・高さ29〜30pxと細長く、
現行まほうつかいの幅22px・高さ27pxと別規格に見えていた。

ゲーム用生成時には輪郭を幅20または22px・高さ28px、上端y=4、下端y=31へ
最近傍で正規化する。色も黒い漆・象牙・役ごとの差し色一系統へ写し、
元候補に強かった茶革と低コントラストを持ち込まない。色替えだけで役を作るのではなく、
被り物・肩幅・持ち物・裾の輪郭は元候補から残す。
